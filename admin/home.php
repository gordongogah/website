        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="order.php"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                    </li>
					<li>
                    ...
                    <li>
                        <a  href="order.php"><i class="fa fa-dashboard"></i> Availibility Calender</a>
                    </li>
                    <li>
                        <a  href="order.php"><i class="fa fa-dashboard"></i> Menus</a>
                    </li>
                    <li>
                        <a  href="order.php"><i class="fa fa-dashboard"></i> Hotel Configuration</a>
                    </li>
                    <li>
                        <a  href="order.php"><i class="fa fa-dashboard"></i> Report</a>
                    </li>
                    <li>
                        <a  href="order.php"><i class="fa fa-dashboard"></i> HR Management</a>
                    </li>
                    <li>
                        <a  href="order.php"><i class="fa fa-dashboard"></i> CMS</a>
                    </li>
                    <li>
                        <a  href="order.php"><i class="fa fa-dashboard"></i> Administative</a>
                    </li>
                    <li>
